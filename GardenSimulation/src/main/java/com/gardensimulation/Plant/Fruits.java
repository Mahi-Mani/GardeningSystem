...
public abstract class Fruits extends Plants {
    ...
    public Fruits(String name, int age, int water_requirement, int maxtemp_level, int mintemp_level, int water_level, ArrayList<Pest> parasites, boolean isAlive, int row, int col) {
    ...
    public Fruits(ArrayList<Pest> currentPests) {
        super(currentPests);
    }
