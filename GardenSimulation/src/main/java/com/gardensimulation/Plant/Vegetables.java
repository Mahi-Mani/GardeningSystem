...
public abstract class Vegetables extends Plants {
    ...
    public Vegetables(String name, int age, int water_requirement, int maxtemp_level, int mintemp_level, int water_level, ArrayList<Pest> parasites, boolean isAlive, int row, int col) {
